...
def retrive_service_manager(monkeypatch, mock_dependencies):
    with (
        patch(
            "rag_app.services.retrive_services.DataManager",
            return_value=mock_dependencies["data_manager"],
        ),
        patch(
            "rag_app.services.retrive_services.DataProcessor",
            return_value=mock_dependencies["data_processor"],
        ),
        patch(
            "rag_app.services.retrive_services.RetriverManager",
            return_value=mock_dependencies["retrive_manager"],
        ),
        patch(
            "rag_app.services.retrive_services.RetriveDBManager",
