...
class Settings(BaseSettings):
    ...
    # Data
    # ------------------------------------------------------------------
    data_directory: str = "src/semantic_search_eng/user_data/data"
    ...
    # Logging
    # ------------------------------------------------------------------
    log_directory: str = "src/semantic_search_eng/user_data/logs"
    ...
    # Evaluation
    # ------------------------------------------------------------------
    evaluation_file: str = "src/semantic_search_eng/evaluation/evalution.json"
