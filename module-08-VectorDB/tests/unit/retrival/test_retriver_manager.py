...
from semantic_search_eng.retrival.retriver_manager import RetriverManager
...
def retriver_manager(monkeypatch, mock_settings):
    ...
    monkeypatch.setattr(
        "semantic_search_eng.retrival.retriver_manager.RetriveDBManager",
        lambda: mock_retrive_db_manager,
    )

    mock_tracker_logger = MagicMock()
    monkeypatch.setattr(
        "semantic_search_eng.retrival.retriver_manager.RetriveTrackerLogger",
