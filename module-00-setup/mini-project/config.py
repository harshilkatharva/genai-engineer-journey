...
try:
    ...
    print(
        "[red]OPENAI_API_KEY is missing in environment variables. Please set it in the .env file.[/red]"
    )
...
try:
    ...
    print(
        "[red]GOOGLE_API_KEY is missing in environment variables. Please set it in the .env file.[/red]"
    )
...
try:
    ...
    print(
        "[red]ANTHROPIC_API_KEY is missing in environment variables. Please set it in the .env file.[/red]"
    )
